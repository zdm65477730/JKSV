...
ui::SlideOutPanel::SlideOutPanel(int width, Side side)
    : m_x(side == Side::Left ? -width : 1280), m_width(width), m_targetX(side == Side::Left ? 0 : 1280 - m_width),
      m_side(side)
{
...
void ui::SlideOutPanel::push_new_element(std::shared_ptr<ui::Element> newElement)
{
